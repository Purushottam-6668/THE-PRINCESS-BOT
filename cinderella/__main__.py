...
PM_START_TEXT = """
Hello *{}* there, I'm [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂 𝙲𝙸𝙽𝙳𝙴𝚁𝙴𝙻𝙻𝙰𒆜𓊉](https://telegra.ph/file/bf3ded9c4c4b7c345167b.jpg)

➲ I am an Lady And Most interesting Group Managing Bot and I will help in managing your group

➲ Make sure you read *INFORMATIOM* Section Below ✰
"""


HELP_STRINGS = """
Hey there! My name is [*{}*.](https://telegra.ph/file/6e1d214530e27a877a523.jpg)
I'm a modular group management bot with a few fun extras! Have a look at the following for an idea of some of \
the things I can help you with.
*Main* commands available:
	*Main Commands Of :* [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂𒆜𓊉](https://telegra.ph/file/bfa66b588acedfc8c24ac.jpg)
💠➥ /start: _Starts me! You've probably already used this_🤓
💠➥ /help: _Click this, I'll let you know about myself!_🤔
...
SOURCE_STRING = """
💫  ༆ ALL AVAILABLE INFO AND SAURCE CODES CAN BE FOUND HERE 👉 𓊈𒆜𝚂𝙰𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴𒆜𓊉(https://t.me/PRINCESS_SUPPORT).
💫 CODE OWNERS AND DEVLOPERS.
    🔎➥ [FOUNDER](https://t.me/Mr_Purushottam_M)
     👨‍💻➥[MOD 1 ](https://t.me/sangramghangale)
     👨‍💻➥ [MOD 2](https://t.me/AniMesH941)
"""
...
if START_IMG is None:
    img = "https://telegra.ph/file/4d5d45037ac863f009e6f.jpg"
else:
  img = START_IMG    
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya,{} Here..\nHow can I help you? Tell me something something 😺 🙂".format(bot.first_name),reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="𓊈𒆜HELP & COMMANDS 𒆜𓊉",url="t.me/{}?start=help".format(bot.username))]]))
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="𓊈𒆜HELP 𒆜𓊉",callback_data="help_back"),InlineKeyboardButton(text="𓊈𒆜DEVLOPER𒆜𓊉",url="https://t.me/Surv_ivor")]]
    keyboard += [[InlineKeyboardButton(text="𓊈𒆜CONNECT YOUR GROUP𒆜𓊉", callback_data="main_connect"),InlineKeyboardButton(text="𓊈𒆜ADD ME 𒆜𓊉",url="t.me/{}?startgroup=true".format(bot.username))]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="𓊈𒆜DEVELOPER𒆜𓊉",url="https://t.me/Mr_Purushottam_M")]]))
        return
...
def get_settings(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        if is_user_admin(chat, user.id):
            ...
            msg.reply_text(text,
                           reply_markup=InlineKeyboardMarkup(
                               [[InlineKeyboardButton(text="𓊈𒆜SETTINGS𒆜𓊉",
